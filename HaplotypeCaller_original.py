...
"""
Execution test:
python3 /n/data1/hms/dbmi/park/victor/scripts/GATK_Germline_SNPs_Indels/HaplotypeCaller_original.py -in_file /n/data1/hms/dbmi/park/victor/other/tests/5817_liver_bulk.bam -out /n/data1/hms/dbmi/park/victor/other/tests/

python3 /n/data1/hms/dbmi/park/victor/scripts/GATK_Germline_SNPs_Indels/HaplotypeCaller_original.py -in_file /n/data1/hms/dbmi/park/victor/Doga/test/s_DS_bkm_097_N_bc0050_Proj_5065_E_L000_mrg_cl_aln_srt_MD_IR_BR.bam -out /n/data1/hms/dbmi/park/victor/Doga/test 

python3 /n/data1/hms/dbmi/park/victor/scripts/GATK_Germline_SNPs_Indels/HaplotypeCaller_original.py -in_file /home/vym1/s_DS_bkm_129_T1_bc0028_Proj_5065_E_L000_mrg_cl_aln_srt_MD_IR_BR.bam -out /home/vym1/

python3 /n/data1/hms/dbmi/park/victor/scripts/GATK_Germline_SNPs_Indels/HaplotypeCaller_original.py -in_file /n/data1/hms/dbmi/park/victor/Doga/test/DS-bkm-087-N/GATK_multilane/.PreProcessing/DS-bkm-087-N_CCTAATCC_COMBINED.SingleRG.bam -out /n/data1/hms/dbmi/park/victor/Doga/test/
...
def parse_args():
    ...
    parser.add_argument('-L', '--scattered_calling_intervals_list', default='/n/data1/hms/dbmi/park/victor/scripts/GATK_Germline_SNPs_Indels/b37_wgs_scattered_calling_intervals.txt', help='Reference genome-dependent. Scattered calling interval list')
    parser.add_argument('-n', '--num_cores', default='2', help='slurm job submission option')
    parser.add_argument('-t', '--runtime', default='3-12:00:00', help='slurm job submission option')
    parser.add_argument('-t2', '--cromruntime', default='2500', help='cromwell run time; please specify as number of minutes')
    ...
    #parser.add_argument('-overrides', '--overrides_path', default='/n/data1/hms/dbmi/park/alon/software/gatk4-data-processing-master/overrides.conf.2', help='path to overrides.conf file')
    parser.add_argument('-overrides', '--overrides_path', default='/n/data1/hms/dbmi/park/victor/scripts/GATK_Germline_SNPs_Indels/overrides.conf.new', help='path to overrides.conf file')
    ...
    parser.add_argument('-input_json', '--input_json_path', default='/n/data1/hms/dbmi/park/victor/scripts/GATK_Germline_SNPs_Indels/haplotypecaller-gvcf-gatk4.hg37.wgs.inputs.json', help='Reference genome-dependent. Path to gatk4-haplotypecaller file')
